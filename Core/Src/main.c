...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Leds_Pin|motor2dir_Pin|motor1dir_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Leds_Pin motor2dir_Pin motor1dir_Pin */
  GPIO_InitStruct.Pin = Leds_Pin|motor2dir_Pin|motor1dir_Pin;
