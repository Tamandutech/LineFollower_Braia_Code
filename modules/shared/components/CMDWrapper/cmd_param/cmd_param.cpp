...
void register_map_SaveRuntime(void)
{
    ...
    better_console_cmd_register(&map_SaveRuntime_cmd);
...
void register_map_add(void)
{
    ...
    better_console_cmd_register(&map_add_cmd);
}
static struct
{
    struct arg_str *MapString;
...
void register_map_set(void)
{
    ...
    better_console_cmd_register(&map_set_cmd);
}
...
void register_map_getRuntime(void)
{
    ...
    better_console_cmd_register(&map_getRuntime_cmd);
...
void register_map_get(void)
{
    ...
    better_console_cmd_register(&map_get_cmd);
