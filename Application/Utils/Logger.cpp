...
Logger::Logger(const char *newTag,
               bool newShowTag,
               Level newLevel) : tag(nullptr) {
...
void Logger::setUseDoubleBreak(bool useDoubleBreak) {
  Logger::useDoubleBreak = useDoubleBreak;
}

void Logger::setShowLogLevel(bool showLogLevel) {
  Logger::showLogLevel = showLogLevel;
}
